...
public class ForumUserTestSuite {
    ...
    public void testGetLocationsOfFriends() {
        ...
        ForumUser user4 = new ForumUser("booty", "Mya Booth", "Washington");
        ...
        Assert.assertFalse(user1.getLocationsOfFriends().contains("Orlandos"));
    }
    ...
    public void testGetLocationOfFriendsOfFriends() {
        ...
        Assert.assertFalse(user1.getLocationOfFriendsOfFriends().contains("Orlandos"));
    }
}
